...
class MagazineSubscriptionForm(forms.ModelForm):
	...
	STATE_CHOICES = (('AP' ,'Andhra Pradesh'),('AR' ,'Arunachal Pradesh'),('AS' ,'Assam'),('BR' ,'Bihar'),('CT' ,'Chhattisgarh'),('GA' ,'Goa'),('GJ' ,'Gujrat'),('HR' ,'Haryana'),('HP' ,'Himachal Pradesh'),('JK' ,'Jammu and Kashmir'),('JH' ,'Jharkhand'),('KA' ,'Karnataka'),('KL' ,'Kerala'),('MP' ,'Madhya Pradesh'),('MH' ,'Maharashtra'),('MN' ,'Manipur'),('ML' ,'Meghalaya'),('MZ' ,'Mizoram'),('OR' ,'Odisha'),('PB' ,'Punjab'),('RJ' ,'Rajasthan'),('SK' ,'Sikkim'),('TN' ,'Tamil Nadu'),('TG' ,'Telangana'),('TR' ,'Tripura'),('UP' ,'Uttar Pradesh'),('UT' ,'Uttrakhand'),('WB' ,'West Bengal'),('AN' ,'Andaman and Nicobar Islands'),('CN' ,'Chandigarh'),('DN' ,'Dadra and Nagar Haveli'),('DD' ,'Daman and Diu'),('LD' ,'Lakshadweep'),('DL' ,'National Capital Territory of India'),('PY' ,'Puducherry'))
	...
	subscriber_address = forms.CharField(label="Subscriber Address", max_length=100, required=True)
	subscriber_address_1 = forms.CharField(label="", max_length=100, required=True)
	subscriber_address_2 = forms.CharField(label="", max_length=100, required=False)
	...
	class Meta:
		...
		exclude = ('user_id', 'subscription_id' , 'subscriber_pincode' , 'subscriber_state')
	...
	def clean_subscription_end_date(self):
		...
		if self.cleaned_data.get("subscription_start_date") > self.cleaned_data.get("subscription_end_date"):
